...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=362070');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "362070");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "0b21ad39433e345803d68f18fcf8cc216a5941e7d8a4560e7d205e09ce79d467");
define('CREATED_TIMESTAMP', "1676325125");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor362070');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor362070');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "lifenomade.com",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "lifenomade.com",
));
